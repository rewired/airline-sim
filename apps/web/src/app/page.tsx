...
export default function Home() {
    ...
    if (error || !overview) return <div className="p-8 text-red-500">Error loading dashboard</div>;
    ...
    return (
        <main className="p-8 space-y-8 max-w-[1600px] mx-auto">
            <div>
                ...
                <p className="text-muted-foreground">Welcome back. Here is the operational status of {overview.airline.name}.</p>
            </div>
