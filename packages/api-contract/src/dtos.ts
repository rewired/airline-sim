...
export type NetworkRouteCandidateResponse = z.infer<
  typeof NetworkRouteCandidateResponseSchema
>;
...
export const ValidationResultSchema = z.object({
  ...
  errors: z.array(
    z.object({
      code: z.string(),
      message: z.string(),
      affectedLegIds: z.array(z.string().uuid()).optional(),
    }),
  ),
  warnings: z.array(
    z.object({
...
export type OpsActiveIncidentsResponse = z.infer<
  typeof OpsActiveIncidentsResponseSchema
>;
